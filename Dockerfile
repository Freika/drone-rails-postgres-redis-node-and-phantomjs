...
# redis 3.2.6
RUN wget -q http://redis.googlecode.com/files/redis-3.2.6.tar.gz && tar -xzf redis-3.2.6.tar.gz && cd redis-3.2.6/ && make \
    && cd src && make all && sudo make install && cd src && make install && redis-server redis.conf
